...
<template>
  <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px; height: 100vh">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      <li class="nav-item">
        <RouterLink to="/about" class="nav-link" exact-active-class="active"> DashBoard </RouterLink>
      </li>
      <li class="nav-item">
        <RouterLink to="/view" class="nav-link" exact-active-class="active"> All Employees </RouterLink>
      </li>
      <li class="nav-item">
        <RouterLink to="/add" class="nav-link" exact-active-class="active"> Add Employees </RouterLink>
      </li>
    </ul>
    <hr>
    <div class="dropdown">
